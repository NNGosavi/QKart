...
public class SearchResult {
    ...
    public Boolean openSizechart() {
        try {
            ...
            return parentElement.findElement(By.xpath("//*[@role='presentation']//p")).isDisplayed();
        } catch (Exception e) {
    ...
    public Boolean verifySizeChartExists() {
        ...
        try {
           ...
           /*if(parentElement.findElement(By.xpath("(//button[text()='Size chart'])[1]")).isDisplayed()){

            if(("SIZE CHART").equalsIgnoreCase(parentElement.findElement(By.xpath("(//button[text()='Size chart'])[1]")).getText())){
                status = true;            
            }
           }*/
            return status;
    ...
    public Boolean validateSizeChartContents(List<String> expectedTableHeaders,
        ...
        try {
            ...
            System.out.println(tableR1);

            System.out.println(tableR1.size());
