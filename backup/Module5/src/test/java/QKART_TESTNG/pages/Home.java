...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            //wait.until(ExpectedConditions.or(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//*[@class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-md-3 css-sycj1h'][1]"), ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//h4")))))))
            //wait.until(ExpectedConditions.or(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[@class='MuiCardContent-root css-1qw96cp'][1]/p[contains(text(),'%s')]"))));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
